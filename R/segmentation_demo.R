...
# https://kmezhoud.github.io/cytopathology/k-means/
# https://rwalk.xyz/color-quantization-in-r/

segmentation_demo <- function(){
  library("jpeg")
  library("png")
  library("graphics")
  library("ggplot2")
  ...
  raw.img <- png.image.shrink( imager::load.image("/Users/png/Downloads/Untitled.png"), reduce=1, rotate=TRUE)
  reduced.img <- png.image.shrink( imager::load.image("/Users/png/Downloads/Untitled.png"), reduce=10, rotate=TRUE)
  ...
  # we can work with both JPEGs and PNGS.  For simplicty, we'll always write out to PNG though.
  raw.img <- png.image.shrink( imager::load.image("/Users/png/Downloads/Untitled.png"), reduce=1, rotate=TRUE)
  reduced.img <- png.image.shrink( imager::load.image("/Users/png/Downloads/Untitled.png"), reduce=20, rotate=TRUE)
